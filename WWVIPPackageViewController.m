...
#pragma mark --- 支付选择
    ...
    [self.weChatBtn addTarget:self action:@selector(paySelectClickEvent:) forControlEvents:UIControlEventTouchUpInside];
    ...
    allPayView.backgroundColor = [UIColor clearColor];
    ...
    [self.allPayBtn addTarget:self action:@selector(paySelectClickEvent:) forControlEvents:UIControlEventTouchUpInside];
...
- (void)paySelectClickEvent:(UIButton *)sender{
